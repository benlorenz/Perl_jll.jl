...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Perl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("83958c19-0796-5285-893e-a1267f8ec499"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Perl", artifacts_toml) for e in artifacts["Perl"]]
...
if best_platform === nothing
    @debug("Unable to load Perl; unsupported platform $(triplet(platform_key_abi()))")
else
